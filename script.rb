...
transactions = TransactionGenerator
                                .new(start_date: [2008, 1, 1], end_date: [2008, 12, 31], num_of_users: 10_000)
                                .create_transactions

p 'start writing to csv: ' + Time.new.to_s
CSV.open('D:/Artsemi_Dzmitryieu/Module4/Exit_Task/dataset/transactions.csv', 'w') do |csv|
  csv << ['invoice_no', 'quantity', 'tax_amount', 'total_price', 'date', 'user_id', 'product_id', 'country', 'city', 'street_name', 'building', 'postal_code']
